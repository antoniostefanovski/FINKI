...
namespace AlbumMVC.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,AlbumArtURL,ArtistId,GenreId")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Price,AlbumArtURL,ArtistId,GenreId")] Album album)
        {
            if (ModelState.IsValid)
            {
