namespace AlbumMVC.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Stores", "Genre_Id", "dbo.Genres");
            DropForeignKey("dbo.Albums", "Store_Id", "dbo.Stores");
            ...
            DropIndex("dbo.Stores", new[] { "Genre_Id" });
            DropIndex("dbo.Albums", new[] { "Store_Id" });
